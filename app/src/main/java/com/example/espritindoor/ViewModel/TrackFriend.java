...
import com.example.espritindoor.ImageView.MultiLocationMapView;
...
import com.example.espritindoor.channel.LocationSource;
import com.example.espritindoor.channel.pubnub.PubNubLocationChannelImpl;
import com.example.espritindoor.technique.ExampleUtils;
import com.example.espritindoor.technique.SharingUtils;
...
public class TrackFriend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExampleUtils.shareTraceId(findViewById(R.id.map),TrackFriend.this,
                mLocationManager);
    }
