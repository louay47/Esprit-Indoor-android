package com.example.espritindoor.ImageView;
 ...
 *
 * The x and y CoordinateInfos are unit independent, so you can use them with pixel, metric, or even
 * latitude-longitude CoordinateInfos.
 */
public class SmoothEstimate {
    ...
    /**
     * Smoothly updates the estimate CoordinateInfos according to the speed ratio and time elapsed
     * from last update
